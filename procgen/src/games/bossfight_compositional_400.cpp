...
const std::string NAME = "bossfight_compositional_400";
...
class BossfightCompositional400Game : public BasicAbstractGame {
  public:
...
REGISTER_GAME(NAME, BossfightCompositional400Game);
