...
const std::string NAME = "bossfight_compositional_100";
...
class BossfightCompositional100Game : public BasicAbstractGame {
  public:
...
REGISTER_GAME(NAME, BossfightCompositional100Game);
