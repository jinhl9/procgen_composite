...
def train(env, max_num_episode: int, lr: float, crop: bool,
          random_policy: bool, policy: bool, save_frequency: int):
...
if __name__ == '__main__':
    ...
    cumul_reward, reward_history, W_saved = train(
        env=env,
